...
const profiles: UserInfo[] = [
  {
    ...
    baseInfo: {
      name: 'Sophie Au',
      city: 'Berlin, Germany',
      bio: "I'm a full-stack developer and web designer with a passion for user experience design and agile consulting. When I'm not coding or designing, I can be found exploring Berlin's hipster coffee shops.",
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      ...
      bio: "I'm a twenty-three-years-old consultant developer focused on building web solutions for real-life problems, most of the time using JavaScript. I'm currently working for ThoughtWorks.",
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      ...
      bio: 'I am a business analyst living in Brisbane, Australia. I have a Bachelor of Information Technology from the University of Queensland with a focus on web and user experience design.',
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      ...
      city: 'Dallas, TX, USA',
      bio: "Hi, I'm Jackie, a software developer from Slidell, Louisiana. Fun Facts: I'm an identical twin. Fun Fact 2: I'm not named after the baseball player. I love Android. I have serious obsession with music. Did I mention I love Android?",
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      ...
      bio: "I'm a full-stack developer with a passion for back-end development, data analytics and agile consulting. When I'm not coding, you can find me, the gardener, the gamer or the artist!",
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      ...
      bio: "I'm a tennis fan with a big passion for trains, lately discovered DevOps which I am very interested in mastering. AWS and Terraform fan and doing AR in iOS as a hobby. Pushing to launch my first mobile app and speak at a conference.",
      bioShort:
  ...
  },
  {
    ...
    baseInfo: {
      name: 'Nimish Singh',
      city: 'Gurgaon, India',
      bio: 'I enjoy looking through different technologies and tools (not limited to any one domain as of now). I am a sincere guy who thrives in a team environment. I also enjoy making pencil sketches and reading books.',
      bioShort:
