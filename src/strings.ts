...
const internalLink = (text: string, url: string) =>
  `<a href="${url}">${text}</a>`;
const externalLink = (text: string, url: string) =>
...
export const blog = {
  ...
  title: "Spicy Blog",
  hero: `We're the ${
    internalLink("Spicy Sea Shells", paths.about)
...
export const notFound = {
  ...
  heading: "Oh No!",
  body: `This page doesn't seem to exist. Maybe check out the ${
    internalLink("blog", paths.blog)
  } instead?`,
};
